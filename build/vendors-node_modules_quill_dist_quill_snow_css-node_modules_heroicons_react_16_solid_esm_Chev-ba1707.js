(self["webpackChunkservv_plugin"] = self["webpackChunkservv_plugin"] || []).push([["vendors-node_modules_quill_dist_quill_snow_css-node_modules_heroicons_react_16_solid_esm_Chev-ba1707"],{
...
class Editor {
    ...
    normalizedOps.reduce((index, op) => {
      ...
      if (op.insert != null) {
        ...
        if (typeof op.insert === 'string') {
          ...
          let formats = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, (0,_blots_block_js__WEBPACK_IMPORTED_MODULE_2__.bubbleFormats)(line));
          if (line instanceof _blots_block_js__WEBPACK_IMPORTED_MODULE_2__["default"]) {
            ...
            if (leaf) {
              formats = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)(formats, (0,_blots_block_js__WEBPACK_IMPORTED_MODULE_2__.bubbleFormats)(leaf));
            }
          }
          ...
          if (isInlineEmbed) {
            ...
            if (leaf) {
              const formats = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, (0,_blots_block_js__WEBPACK_IMPORTED_MODULE_2__.bubbleFormats)(leaf));
              attributes = quill_delta__WEBPACK_IMPORTED_MODULE_1__.AttributeMap.diff(formats, attributes) || {};
            }
          }
        }
  ...
  formatLine(index, length) {
    ...
    this.scroll.optimize();
    const delta = new quill_delta__WEBPACK_IMPORTED_MODULE_1__().retain(index).retain(length, (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(formats));
  ...
  insertText(index, text) {
    ...
    return this.update(new quill_delta__WEBPACK_IMPORTED_MODULE_1__().retain(index).insert(text, (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(formats)));
  }
  isBlank() {
  ...
  update(change) {
    ...
    mutations[0].target.data.match(ASCII) && this.scroll.find(mutations[0].target)) {
      ...
      this.delta = this.getDelta();
      if (!change || !(0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.isEqual)(oldDelta.compose(change), this.delta)) {
...
function convertHTML(blot, index, length) {
  ...
  if (blot instanceof _blots_text_js__WEBPACK_IMPORTED_MODULE_5__["default"]) {
    const escapedText = (0,_blots_text_js__WEBPACK_IMPORTED_MODULE_5__.escapeText)(blot.value().slice(index, index + length));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Parchment: () => (/* reexport module object */ parchment__WEBPACK_IMPORTED_MODULE_12__),
/* harmony export */   Range: () => (/* reexport safe */ _selection_js__WEBPACK_IMPORTED_MODULE_7__.Range),
...
class Quill {
  ...
  static events = _emitter_js__WEBPACK_IMPORTED_MODULE_3__["default"].events;
  static sources = _emitter_js__WEBPACK_IMPORTED_MODULE_3__["default"].sources;
...
function expandConfig(containerOrSelector, options) {
  ...
  const modules = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, expandModuleConfig(quillModuleDefaults), expandModuleConfig(themeModuleDefaults), userModuleOptions);
  const config = {
    ...quillDefaults,
  ...
  return {
    ...
    modules: Object.entries(modules).reduce((modulesWithDefaults, _ref2) => {
      ...
      return {
        ...modulesWithDefaults,
        // @ts-expect-error
        [name]: (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, moduleClass.DEFAULTS || {}, value)
      };
    }, {}),
...
class Selection {
  ...
  update() {
    ...
    if (!(0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.isEqual)(oldRange, this.lastRange)) {
      ...
      const args = [_emitter_js__WEBPACK_IMPORTED_MODULE_1__["default"].events.SELECTION_CHANGE, (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(this.lastRange), (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(oldRange), source];
      ...
      const prevented = matches.some(binding => {
        ...
        if (Array.isArray(binding.format)) {
          ...
          if (!Object.keys(binding.format).every(name => {
            ...
            // @ts-expect-error Fix me later
            return (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.isEqual)(binding.format[name], curContext.format[name]);
          })) {
            return false;
          }
        }
...
function normalize(binding) {
  if (typeof binding === 'string' || typeof binding === 'number') {
    ...
    binding = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.cloneDeep)(binding);
  } else {
    return null;
  }
  if (binding.shortKey) {
...
BaseTheme.DEFAULTS = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, _core_theme_js__WEBPACK_IMPORTED_MODULE_2__["default"].DEFAULTS, {
  modules: {
    toolbar: {
      handlers: {
        formula() {
...
BubbleTheme.DEFAULTS = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, _base_js__WEBPACK_IMPORTED_MODULE_2__["default"].DEFAULTS, {
  modules: {
    toolbar: {
      handlers: {
        link(value) {
...
SnowTheme.DEFAULTS = (0,lodash_es__WEBPACK_IMPORTED_MODULE_0__.merge)({}, _base_js__WEBPACK_IMPORTED_MODULE_2__["default"].DEFAULTS, {
  modules: {
    toolbar: {
      handlers: {
        link(value) {
...
//# sourceMappingURL=vendors-node_modules_quill_dist_quill_snow_css-node_modules_heroicons_react_16_solid_esm_Chev-ba1707.js.map?ver=9f17e1820da83c153900